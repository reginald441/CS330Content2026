 ...
 * linmath.h
 * ==========
 * A lightweight linear algebra library for vector and matrix operations in C.
 * This library is designed for simplicity and performance, providing inline
 * implementations of common mathematical operations for 2D, 3D, and 4D vectors,
 * as well as 4x4 matrices and quaternions.
 *
 * PURPOSE:
 * - Provides a minimal set of functions for mathematical operations in graphics
 *   programming, game development, or any application requiring linear algebra.
 * - Includes support for vector addition, subtraction, scaling, normalization,
 *   dot products, cross products, and reflections.
 * - Includes 4x4 matrix operations for transformations, rotations, projections,
 *   and matrix multiplications.
 * - Supports quaternion arithmetic for rotations.
 *
 * FEATURES:
 * - Inline function definitions for performance optimization.
 * - Macro-based templates for extensibility across vector dimensions (vec2, vec3, vec4).
 * - Minimal dependencies: requires only standard math libraries (`math.h`).
 * - Portable and self-contained, with optional inline function inclusion controlled
 *   by the `LINMATH_NO_INLINE` macro.
 *
 * USAGE:
 * - Include this header file in your project to access vector, matrix, and quaternion
 *   operations. Inline functions ensure low overhead for high-performance applications.
 *
 * AUTHOR:
 * - Original Author: datenwolf https://github.com/datenwolf/linmath.h
 * - Contributions and maintenance by the open-source community.
 * - Updated on: June 19,2022
 *
 * LICENSE:
 * - This library is distributed as open source. If used in a project, ensure that
 *   proper credit is given as required by the specific license.
 *
 ******************************************************************************/
