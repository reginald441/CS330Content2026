...
// maincode.cpp
// ============
// Entry point of the application. Responsible for initializing the OpenGL 
// environment using GLEW and GLFW, setting up the rendering pipeline, and 
...
//
// RESPONSIBILITIES:
// - Initialize GLFW and configure the OpenGL context.
// - Initialize GLEW for OpenGL extensions support.
// - Set up and manage the main application window.
// - Integrate `SceneManager`, `ViewManager`, and `ShaderManager` for 
//   rendering the 3D scene.
// - Handle user input and manage the main rendering loop.
//
// NOTE: This implementation uses GLEW for handling OpenGL extensions, GLFW 
// for window and input management, and GLM for mathematical operations.
///////////////////////////////////////////////////////////////////////////////
...
namespace
{
	...
	const char* const WINDOW_TITLE = "2-2 Assignment"; 
