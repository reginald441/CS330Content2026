...
void SceneManager::SetupSceneLights()
{
	...
	m_pShaderManager->setVec3Value("pointLights[0].position", 0.0f, 6.0f, 6.0f);
	...
	m_pShaderManager->setVec3Value("pointLights[1].position", -3.0f, 2.0f, 4.0f);
	m_pShaderManager->setVec3Value("pointLights[1].ambient", 0.3f, 0.08f, 0.12f);
	m_pShaderManager->setVec3Value("pointLights[1].diffuse", 1.0f, 0.25f, 0.35f);
	m_pShaderManager->setVec3Value("pointLights[1].specular", 1.0f, 0.5f, 0.5f);
